...
export type DomainConfig<Locales extends AllLocales> = Omit<RoutingBaseConfig<Locales>, 'locales' | 'localePrefix'> & {
...
type MiddlewareConfig<Locales extends AllLocales> = RoutingBaseConfig<Locales> & {
...
export type MiddlewareConfigWithDefaults<Locales extends AllLocales> = MiddlewareConfig<Locales> & {
    alternateLinks: boolean;
    localePrefix: LocalePrefix;
    localeDetection: boolean;
};
