...
export declare const getIntl: () => Promise<{
    formatDateTime: (value: number | Date, formatOrOptions?: string | import("use-intl/dist/types/src/core/DateTimeFormatOptions").default | undefined) => string;
...
export declare const getTimeZone: (locale?: string | {
    locale: string;
} | undefined) => Promise<import("use-intl/dist/types/src/core/TimeZone").default | undefined>;
...
export declare const getTranslations: <NestedKey extends string = never>(namespace?: NestedKey | undefined) => Promise<{
    <TargetKey extends import("use-intl/dist/types/src/core/utils/MessageKeys").default<import("use-intl/dist/types/src/core/utils/NestedValueOf").default<{
        ...
        '!': IntlMessages;
    }, [NestedKey] extends [never] ? "!" : `!.${NestedKey}`>>>>(key: TargetKey, values?: import("use-intl/dist/types/src/core/TranslationValues").default | undefined, formats?: Partial<import("use-intl/dist/types/src/core/Formats").default> | undefined): string;
    rich<TargetKey_1 extends import("use-intl/dist/types/src/core/utils/MessageKeys").default<import("use-intl/dist/types/src/core/utils/NestedValueOf").default<{
        ...
        '!': IntlMessages;
    }, [NestedKey] extends [never] ? "!" : `!.${NestedKey}`>>>>(key: TargetKey_1, values?: import("use-intl").RichTranslationValuesPlain | undefined, formats?: Partial<import("use-intl/dist/types/src/core/Formats").default> | undefined): string;
    raw<TargetKey_2 extends import("use-intl/dist/types/src/core/utils/MessageKeys").default<import("use-intl/dist/types/src/core/utils/NestedValueOf").default<{
        '!': IntlMessages;
    }, [NestedKey] extends [never] ? "!" : `!.${NestedKey}`>, import("use-intl/dist/types/src/core/utils/NestedKeyOf").default<import("use-intl/dist/types/src/core/utils/NestedValueOf").default<{
        '!': IntlMessages;
...
export declare const getMessages: (locale: string) => Promise<import("use-intl/dist/types/src/core/AbstractIntlMessages").default | undefined>;
